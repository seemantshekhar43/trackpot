...
abstract class GroupRepository {
  Stream<Either<Failure, List<GroupSummary>>> watchUserGroups(String userId);
  ...
  Future<Either<Failure, void>> deleteGroup(group_entity.Group group);
  ...
  Future<Either<Failure, group_entity.Group>> removeMember(
      group_entity.Group group, GroupMember member);
  Future<Either<Failure, GroupMember>> updateGroupMember(GroupMember member);
  ...
  Stream<Either<Failure, group_entity.Group>> watchGroupById(String groupId);
}
